        ...
        <ul className="grid gap-10 md:grid-cols-2 md:text-balance">
          <li className="flex space-x-6 self-center">
            ...
            <div className="space-y-2">
              ...
              <p>
                Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                Expedita iusto, perferendis cupiditate, voluptatem similique,
                nisi omnis optio voluptatum aperiam culpa vel fuga? A quasi
                nesciunt, nam asperiores minus harum repudiandae!
              </p>
            </div>
          </li>
          <li className="flex space-x-6 self-center">
