    ...
    <main className="bg-background lg:h-screen">
      <section className="flex h-full w-full p-4">
        ...
        <div className="flex-1 p-1 max-lg:min-h-screen">
          <div className="flex min-h-full w-full flex-col items-center rounded-xl bg-card-background p-10 md:pt-20 lg:px-32 xl:px-40">
            ...
            <form action="" className="mt-10 w-full space-y-10">
              ...
              <div className="space-y-2">
                <button
                  className="w-full rounded-full bg-primary px-2 py-3 font-medium text-primary-foreground transition hover:bg-primary/80"
                  type="submit"
                >
                  Log in
                </button>
                <button className="text-muted-foreground flex w-full place-content-center items-center gap-1 rounded-full bg-muted/80 px-2 py-3 font-medium transition-all hover:bg-muted/80">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    x="0px"
                    y="0px"
